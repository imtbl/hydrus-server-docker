...
The latest build runs [hydrus server version 350][hydrus-server-version].
...
```zsh
user@local:~$ docker pull mserajnik/hydrus-server-docker:350
```
...
[hydrus-server-version]: https://github.com/hydrusnetwork/hydrus/releases/tag/v350
...
[hydrus-server-badge]: https://img.shields.io/badge/hydrus%20server-version%20350-blue.svg
