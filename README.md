...
The latest build runs [hydrus server version 337][hydrus-server-version].
...
```zsh
user@local:~$ docker pull mserajnik/hydrus-server-docker:337
```
...
[hydrus-server-version]: https://github.com/hydrusnetwork/hydrus/releases/tag/v337
...
[hydrus-server-badge]: https://img.shields.io/badge/hydrus%20server-version%20337-blue.svg
