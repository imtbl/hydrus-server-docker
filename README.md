...
The latest build runs [hydrus server version 365][hydrus-server-version].
...
```zsh
user@local:~$ docker pull mserajnik/hydrus-server-docker:365
```
...
[hydrus-server-version]: https://github.com/hydrusnetwork/hydrus/releases/tag/v365
...
[hydrus-server-badge]: https://img.shields.io/badge/hydrus%20server-version%20365-blue.svg
