...
The latest build runs [hydrus server version 367][hydrus-server-version].
...
```zsh
user@local:~$ docker pull mserajnik/hydrus-server-docker:367
```
...
[hydrus-server-version]: https://github.com/hydrusnetwork/hydrus/releases/tag/v367
...
[hydrus-server-badge]: https://img.shields.io/badge/hydrus%20server-version%20367-blue.svg
