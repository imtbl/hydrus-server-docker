...
The latest build runs [hydrus server version 372][hydrus-server-version].
...
```zsh
user@local:~$ docker pull mserajnik/hydrus-server-docker:372
```
...
[hydrus-server-version]: https://github.com/hydrusnetwork/hydrus/releases/tag/v372
...
[hydrus-server-badge]: https://img.shields.io/badge/hydrus%20server-version%20372-blue.svg
