...
The latest build runs [hydrus server version 363][hydrus-server-version].
...
```zsh
user@local:~$ docker pull mserajnik/hydrus-server-docker:363
```
...
[hydrus-server-version]: https://github.com/hydrusnetwork/hydrus/releases/tag/v363
...
[hydrus-server-badge]: https://img.shields.io/badge/hydrus%20server-version%20363-blue.svg
