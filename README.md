...
The latest build runs [hydrus server version 380][hydrus-server-version].
...
```zsh
user@local:~$ docker pull mserajnik/hydrus-server-docker:380
```
...
[hydrus-server-version]: https://github.com/hydrusnetwork/hydrus/releases/tag/v380
...
[hydrus-server-badge]: https://img.shields.io/badge/hydrus%20server-version%20380-blue.svg
