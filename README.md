...
The latest build runs [hydrus server version 341][hydrus-server-version].
...
```zsh
user@local:~$ docker pull mserajnik/hydrus-server-docker:341
```
...
[hydrus-server-version]: https://github.com/hydrusnetwork/hydrus/releases/tag/v341
...
[hydrus-server-badge]: https://img.shields.io/badge/hydrus%20server-version%20341-blue.svg
