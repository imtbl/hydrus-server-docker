...
The latest build runs [hydrus server version 355][hydrus-server-version].
...
```zsh
user@local:~$ docker pull mserajnik/hydrus-server-docker:355
```
...
[hydrus-server-version]: https://github.com/hydrusnetwork/hydrus/releases/tag/v355
...
[hydrus-server-badge]: https://img.shields.io/badge/hydrus%20server-version%20355-blue.svg
