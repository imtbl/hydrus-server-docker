...
The latest build runs [hydrus server version 353][hydrus-server-version].
...
```zsh
user@local:~$ docker pull mserajnik/hydrus-server-docker:353
```
...
[hydrus-server-version]: https://github.com/hydrusnetwork/hydrus/releases/tag/v353
...
[hydrus-server-badge]: https://img.shields.io/badge/hydrus%20server-version%20353-blue.svg
