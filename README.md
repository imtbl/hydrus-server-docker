...
The latest build runs [hydrus server version 364][hydrus-server-version].
...
```zsh
user@local:~$ docker pull mserajnik/hydrus-server-docker:364
```
...
[hydrus-server-version]: https://github.com/hydrusnetwork/hydrus/releases/tag/v364
...
[hydrus-server-badge]: https://img.shields.io/badge/hydrus%20server-version%20364-blue.svg
