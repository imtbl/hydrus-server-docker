...
The latest build runs [hydrus server version 349][hydrus-server-version].
...
```zsh
user@local:~$ docker pull mserajnik/hydrus-server-docker:349
```
...
[hydrus-server-version]: https://github.com/hydrusnetwork/hydrus/releases/tag/v349
...
[hydrus-server-badge]: https://img.shields.io/badge/hydrus%20server-version%20349-blue.svg
