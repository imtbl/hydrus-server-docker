...
The latest build runs [hydrus server version 369][hydrus-server-version].
...
```zsh
user@local:~$ docker pull mserajnik/hydrus-server-docker:369
```
...
[hydrus-server-version]: https://github.com/hydrusnetwork/hydrus/releases/tag/v369
...
[hydrus-server-badge]: https://img.shields.io/badge/hydrus%20server-version%20369-blue.svg
