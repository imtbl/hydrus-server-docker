...
The latest build runs [hydrus server version 352][hydrus-server-version].
...
```zsh
user@local:~$ docker pull mserajnik/hydrus-server-docker:352
```
...
[hydrus-server-version]: https://github.com/hydrusnetwork/hydrus/releases/tag/v352
...
[hydrus-server-badge]: https://img.shields.io/badge/hydrus%20server-version%20352-blue.svg
