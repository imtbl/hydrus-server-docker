...
The latest build runs [hydrus server version 426][hydrus-server-version].
...
```zsh
user@local:~$ docker pull mtbl/hydrus-server-docker:426
```
...
[hydrus-server-version]: https://github.com/hydrusnetwork/hydrus/releases/tag/v426
...
[hydrus-server-badge]: https://img.shields.io/badge/hydrus%20server-version%20426-blue.svg
