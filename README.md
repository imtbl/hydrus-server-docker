...
The latest build runs [hydrus server version 354][hydrus-server-version].
...
```zsh
user@local:~$ docker pull mserajnik/hydrus-server-docker:354
```
...
[hydrus-server-version]: https://github.com/hydrusnetwork/hydrus/releases/tag/v354
...
[hydrus-server-badge]: https://img.shields.io/badge/hydrus%20server-version%20354-blue.svg
