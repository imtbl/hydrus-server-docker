...
The latest build runs [hydrus server version 366][hydrus-server-version].
...
```zsh
user@local:~$ docker pull mserajnik/hydrus-server-docker:366
```
...
[hydrus-server-version]: https://github.com/hydrusnetwork/hydrus/releases/tag/v366
...
[hydrus-server-badge]: https://img.shields.io/badge/hydrus%20server-version%20366-blue.svg
