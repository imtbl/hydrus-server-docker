...
The latest build runs [hydrus server version 338][hydrus-server-version].
...
```zsh
user@local:~$ docker pull mserajnik/hydrus-server-docker:338
```
...
[hydrus-server-version]: https://github.com/hydrusnetwork/hydrus/releases/tag/v338
...
[hydrus-server-badge]: https://img.shields.io/badge/hydrus%20server-version%20338-blue.svg
